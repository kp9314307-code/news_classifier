...
# 2. Программа читает файл
# 3. spaCy токенизирует текст (разбивает на слова)
# 4. Для каждого токена берём лемму (начальную форму слова)
# 5. Сравниваем леммы с ключевыми словами каждой рубрики
# 6. Рубрика с наибольшим числом совпадений — ответ
# ============================================================
